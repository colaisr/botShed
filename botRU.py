...
def process_name_step(message):
    try:
        ...
        msg = bot.reply_to(message, 'Когда предпочитаете ?', reply_markup=markup)
...
def process_day_step(message):
    try:
        ...
        msg = bot.reply_to(message, 'Во сколько?', reply_markup=markup)
...
def process_hour_step(message):
    try:
        ...
        msg = bot.reply_to(message, 'Поточнее?', reply_markup=markup)
